...
for (samples_per_group in c(2, 5, 10, 20, 50)) {
  ...
  for (i in 1:10) {
    filename <- paste0("results.blood_", samples_per_group, "_set", i, "_DE.rds")
  ...
  saveRDS(results.DE, file=here(folder, paste0("DE.results.blood_", samples_per_group, "_DE.rds")))
  saveRDS(results.DEDD, file=here(folder, paste0("DEDD.results.blood_", samples_per_group, "_DE.rds")))
