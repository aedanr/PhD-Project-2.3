...
# trend.DSS only for DEDD2.TMM, DEDD2.DESeqnorm, DEDD5.DESeqnorm, DEDD10.DESeqnorm
# ShrinkBayes only for DEDD2.TMM
{
...
for (i in 1:50) {
  ...
  # import <- paste0('results.DEDD20.',i,'.DESeqnorm.rds')
  res <- readRDS(here('Results/DEDD compcodeR data results July-Aug 2019',import))
  # res <- readRDS(here('Results/DEDD compcodeR data results DESeq norm Sept 2019',import))
...
saveRDS(results.DE, file=here('Results/DEDD compcodeR data results July-Aug 2019','DE.results.DEDD20.TMM.rds'))
saveRDS(results.DE.lfc1, file=here('Results/DEDD compcodeR data results July-Aug 2019','DE.lfc1.results.DEDD20.TMM.rds'))
saveRDS(results.DE.lfc2, file=here('Results/DEDD compcodeR data results July-Aug 2019','DE.lfc2.results.DEDD20.TMM.rds'))
saveRDS(results.DD, file=here('Results/DEDD compcodeR data results July-Aug 2019','DD.results.DEDD20.TMM.rds'))
saveRDS(results.DD.lfc1, file=here('Results/DEDD compcodeR data results July-Aug 2019','DD.lfc1.results.DEDD20.TMM.rds'))
saveRDS(results.DD.lfc2, file=here('Results/DEDD compcodeR data results July-Aug 2019','DD.lfc2.results.DEDD20.TMM.rds'))
saveRDS(results.DEDD, file=here('Results/DEDD compcodeR data results July-Aug 2019','DEDD.results.DEDD20.TMM.rds'))
