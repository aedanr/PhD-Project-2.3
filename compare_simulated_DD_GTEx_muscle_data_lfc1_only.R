...
for (i in 1:10) {
  ...
  rm(counts, DD, DEDD, FC, libsizes, nf, els, sf, norm.counts)
  
}

filename <- paste0("sessionInfo.GTEx_muscle_", samples.per.cond, "_set", i, "_DD.lfc1.rds")
