...
## Keep only one version of each method: MDSeq ZI, lnHM log (long chain for muscle).
...
for (metric in c("pauc", "auc", "fpr", "fdr", "tpr", "mean.fdr", "mean.discoveries")) {
  for (size in c("2", "5", "10", "20", "50")) {
    assign(
      ...
      get(paste0("DD.results.DEDD", size))[[metric]][
        , c("muscle_MD.zi", "muscle_EVQ", "muscle_lnHM.log.lc")
      ]
    )
  }
}
...
plot(NA, xlim=c(1,17), ylim=c(0.48,0.91), xaxt="n", yaxt="n", 
...
legend("bottomright", fill=col_vector[1:3], bty='n', cex=2, ncol=1, 
...
plot(NA, xlim=c(1,17), ylim=c(0,0.035), xaxt="n", yaxt="n", 
...
plot(NA, xlim=c(1,17), ylim=c(0,0.65), xaxt="n", yaxt="n", 
...
plot(mean.discoveries_blood_2$blood_MD.zi, mean.fdr_blood_2$blood_MD.zi, 
...
lines(mean.discoveries_blood_2$blood_EVQ, mean.fdr_blood_2$blood_EVQ, 
...
plot(mean.discoveries_blood_5$blood_MD.zi, mean.fdr_blood_5$blood_MD.zi, 
     type='l', ylim=c(0,0.95), xlim=c(0,2000), lwd=2, col=col_vector[1], cex.axis=3, 
     xlab=NA, ylab=NA, xaxt='n', yaxt='n', main=paste0("5"), cex.main=3)
axis(side=1, at=c(0,500,1000,1500,2000), tick=T, cex.axis=3, mgp=c(3,2,0))
lines(mean.discoveries_blood_5$blood_EVQ, mean.fdr_blood_5$blood_EVQ, 
      lwd=2, col=col_vector[2], cex.axis=3)
lines(mean.discoveries_blood_5$blood_lnHM.log, mean.fdr_blood_5$blood_lnHM.log, 
      lwd=2, col=col_vector[3], cex.axis=3)
abline(h=0.05, col='lightgrey')

plot(mean.discoveries_blood_10$blood_MD.zi, mean.fdr_blood_10$blood_MD.zi, 
     type='l', ylim=c(0,0.95), xlim=c(0,2000), lwd=2, col=col_vector[1], cex.axis=3, 
     xlab=NA, ylab=NA, xaxt='n', yaxt='n', main=paste0("10"), cex.main=3)
axis(side=1, at=c(0,500,1000,1500,2000), tick=T, cex.axis=3, mgp=c(3,2,0))
lines(mean.discoveries_blood_10$blood_EVQ, mean.fdr_blood_10$blood_EVQ, 
      lwd=2, col=col_vector[2], cex.axis=3)
lines(mean.discoveries_blood_10$blood_lnHM.log, mean.fdr_blood_10$blood_lnHM.log, 
      lwd=2, col=col_vector[3], cex.axis=3)
abline(h=0.05, col='lightgrey')

plot(mean.discoveries_blood_20$blood_MD.zi, mean.fdr_blood_20$blood_MD.zi, 
     type='l', ylim=c(0,0.95), xlim=c(0,2000), lwd=2, col=col_vector[1], cex.axis=3, 
     xlab=NA, ylab=NA, xaxt='n', yaxt='n', main=paste0("20"), cex.main=3)
axis(side=1, at=c(0,500,1000,1500,2000), tick=T, cex.axis=3, mgp=c(3,2,0))
lines(mean.discoveries_blood_20$blood_EVQ, mean.fdr_blood_20$blood_EVQ, 
      lwd=2, col=col_vector[2], cex.axis=3)
lines(mean.discoveries_blood_20$blood_lnHM.log, mean.fdr_blood_20$blood_lnHM.log, 
      lwd=2, col=col_vector[3], cex.axis=3)
abline(h=0.05, col='lightgrey')

plot(mean.discoveries_blood_50$blood_MD.zi, mean.fdr_blood_50$blood_MD.zi, 
     type='l', ylim=c(0,0.95), xlim=c(0,2000), lwd=2, col=col_vector[1], cex.axis=3, 
     xlab=NA, ylab=NA, xaxt='n', yaxt='n', main=paste0("50"), cex.main=3)
axis(side=1, at=c(0,500,1000,1500,2000), tick=T, cex.axis=3, mgp=c(3,2,0))
lines(mean.discoveries_blood_50$blood_EVQ, mean.fdr_blood_50$blood_EVQ, 
      lwd=2, col=col_vector[2], cex.axis=3)
lines(mean.discoveries_blood_50$blood_lnHM.log, mean.fdr_blood_50$blood_lnHM.log, 
      lwd=2, col=col_vector[3], cex.axis=3)
abline(h=0.05, col='lightgrey')

plot(mean.discoveries_muscle_2$muscle_MD.zi, mean.fdr_muscle_2$muscle_MD.zi, 
     type='l', ylim=c(0,0.95), xlim=c(0,2000), lwd=2, col=col_vector[1], cex.axis=3, 
     xlab=NA, ylab=NA, xaxt='n')
text("Muscle", x=100, y=0.1, cex=3, adj=0)
lines(mean.discoveries_muscle_2$muscle_EVQ, mean.fdr_muscle_2$muscle_EVQ, 
      lwd=2, col=col_vector[2], cex.axis=3)
lines(mean.discoveries_muscle_2$muscle_lnHM.log.lc, mean.fdr_muscle_2$muscle_lnHM.log.lc, 
      lwd=2, col=col_vector[3], cex.axis=3)
abline(h=0.05, col='lightgrey')

plot(mean.discoveries_muscle_5$muscle_MD.zi, mean.fdr_muscle_5$muscle_MD.zi, 
     type='l', ylim=c(0,0.95), xlim=c(0,2000), lwd=2, col=col_vector[1], cex.axis=3, 
     xlab=NA, ylab=NA, xaxt='n', yaxt='n')
lines(mean.discoveries_muscle_5$muscle_EVQ, mean.fdr_muscle_5$muscle_EVQ, 
      lwd=2, col=col_vector[2], cex.axis=3)
lines(mean.discoveries_muscle_5$muscle_lnHM.log.lc, mean.fdr_muscle_5$muscle_lnHM.log.lc, 
      lwd=2, col=col_vector[3], cex.axis=3)
abline(h=0.05, col='lightgrey')

plot(mean.discoveries_muscle_10$muscle_MD.zi, mean.fdr_muscle_10$muscle_MD.zi, 
     type='l', ylim=c(0,0.95), xlim=c(0,2000), lwd=2, col=col_vector[1], cex.axis=3, 
     xlab=NA, ylab=NA, xaxt='n', yaxt='n')
lines(mean.discoveries_muscle_10$muscle_EVQ, mean.fdr_muscle_10$muscle_EVQ, 
      lwd=2, col=col_vector[2], cex.axis=3)
lines(mean.discoveries_muscle_10$muscle_lnHM.log.lc, mean.fdr_muscle_10$muscle_lnHM.log.lc, 
      lwd=2, col=col_vector[3], cex.axis=3)
abline(h=0.05, col='lightgrey')

plot(mean.discoveries_muscle_20$muscle_MD.zi, mean.fdr_muscle_20$muscle_MD.zi, 
     type='l', ylim=c(0,0.95), xlim=c(0,2000), lwd=2, col=col_vector[1], cex.axis=3, 
     xlab=NA, ylab=NA, xaxt='n', yaxt='n')
lines(mean.discoveries_muscle_20$muscle_EVQ, mean.fdr_muscle_20$muscle_EVQ, 
      lwd=2, col=col_vector[2], cex.axis=3)
lines(mean.discoveries_muscle_20$muscle_lnHM.log.lc, mean.fdr_muscle_20$muscle_lnHM.log.lc, 
      lwd=2, col=col_vector[3], cex.axis=3)
abline(h=0.05, col='lightgrey')

plot(mean.discoveries_muscle_50$muscle_MD.zi, mean.fdr_muscle_50$muscle_MD.zi, 
     type='l', ylim=c(0,0.95), xlim=c(0,2000), lwd=2, col=col_vector[1], cex.axis=3, 
     xlab=NA, ylab=NA, xaxt='n', yaxt='n')
lines(mean.discoveries_muscle_50$muscle_EVQ, mean.fdr_muscle_50$muscle_EVQ, 
      lwd=2, col=col_vector[2], cex.axis=3)
