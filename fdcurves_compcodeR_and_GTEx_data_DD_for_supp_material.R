...
plot(DD.results.compcodeR.DEDD2$mean.discoveries$disp.MDSeq.zi.tmm, 
     ...
     type='l', ylim=c(0,0.9), xlim=c(0,2000), lwd=2, col=col_vector[1], 
...
lines(DD.results.compcodeR.DEDD2$mean.discoveries$EVQ.tmm, 
      DD.results.compcodeR.DEDD2$mean.fdr$EVQ.tmm, 
...
lines(DD.results.compcodeR.DEDD10$mean.discoveries$EVQ.tmm, 
      DD.results.compcodeR.DEDD10$mean.fdr$EVQ.tmm, 
      lwd=2, col=col_vector[2])
...
axis(side=1, mgp=c(3,1.5,0), cex.axis=2.5)
axis(side=2, mgp=c(3,1,0), cex.axis=2.5)
lines(DD.results.compcodeR.DEDD20$mean.discoveries$EVQ.tmm, 
      DD.results.compcodeR.DEDD20$mean.fdr$EVQ.tmm, 
      lwd=2, col=col_vector[2])
...
# Second row - blood
plot(DD.results.GTEx.DEDD2$mean.discoveries$blood_MD.zi, 
     DD.results.GTEx.DEDD2$mean.fdr$blood_MD.zi, 
     type='l', ylim=c(0,0.9), xlim=c(0,2000), lwd=2, col=col_vector[1], 
     yaxt='n', xaxt='n', ylab=NA, xlab=NA)
axis(side=1, mgp=c(3,1.5,0), cex.axis=2.5)
axis(side=2, mgp=c(3,1,0), cex.axis=2.5)
lines(DD.results.GTEx.DEDD2$mean.discoveries$blood_EVQ, 
      DD.results.GTEx.DEDD2$mean.fdr$blood_EVQ, 
      lwd=2, col=col_vector[2], cex.axis=2.5)
lines(DD.results.GTEx.DEDD2$mean.discoveries$blood_lnHM.log, 
      DD.results.GTEx.DEDD2$mean.fdr$blood_lnHM.log, 
...
plot(DD.results.GTEx.DEDD10$mean.discoveries$blood_MD.zi, 
     DD.results.GTEx.DEDD10$mean.fdr$blood_MD.zi, 
     type='l', ylim=c(0,0.9), xlim=c(0,2000), lwd=2, col=col_vector[1], 
     yaxt='n', xaxt='n', ylab=NA, xlab=NA)
axis(side=1, mgp=c(3,1.5,0), cex.axis=2.5)
axis(side=2, mgp=c(3,1,0), cex.axis=2.5)
mtext('GTEx blood data', cex=1.5, side=3, line=-2.5)
lines(DD.results.GTEx.DEDD10$mean.discoveries$blood_EVQ, 
      DD.results.GTEx.DEDD10$mean.fdr$blood_EVQ, 
      lwd=2, col=col_vector[2], cex.axis=2.5)
lines(DD.results.GTEx.DEDD10$mean.discoveries$blood_lnHM.log, 
      DD.results.GTEx.DEDD10$mean.fdr$blood_lnHM.log, 
      lwd=2, col=col_vector[3], cex.axis=2.5)

plot(DD.results.GTEx.DEDD20$mean.discoveries$blood_MD.zi, 
     DD.results.GTEx.DEDD20$mean.fdr$blood_MD.zi, 
     type='l', ylim=c(0,0.9), xlim=c(0,2000), lwd=2, col=col_vector[1], 
     yaxt='n', xaxt='n', ylab=NA, xlab=NA)
axis(side=1, mgp=c(3,1.5,0), cex.axis=2.5)
axis(side=2, mgp=c(3,1,0), cex.axis=2.5)
lines(DD.results.GTEx.DEDD20$mean.discoveries$blood_EVQ, 
      DD.results.GTEx.DEDD20$mean.fdr$blood_EVQ, 
      lwd=2, col=col_vector[2], cex.axis=2.5)
lines(DD.results.GTEx.DEDD20$mean.discoveries$blood_lnHM.log, 
      DD.results.GTEx.DEDD20$mean.fdr$blood_lnHM.log, 
      lwd=2, col=col_vector[3], cex.axis=2.5)
...
# Third row - muscle
plot(DD.results.GTEx.DEDD2$mean.discoveries$muscle_MD.zi, 
     DD.results.GTEx.DEDD2$mean.fdr$muscle_MD.zi, 
     type='l', ylim=c(0,0.9), xlim=c(0,2000), lwd=2, col=col_vector[1], 
     yaxt='n', xaxt='n', ylab=NA, xlab=NA)
axis(side=1, mgp=c(3,1.5,0), cex.axis=2.5)
axis(side=2, mgp=c(3,1,0), cex.axis=2.5)
lines(DD.results.GTEx.DEDD2$mean.discoveries$muscle_EVQ, 
      DD.results.GTEx.DEDD2$mean.fdr$muscle_EVQ, 
      lwd=2, col=col_vector[2], cex.axis=2.5)
lines(DD.results.GTEx.DEDD2$mean.discoveries$muscle_lnHM.log, 
      DD.results.GTEx.DEDD2$mean.fdr$muscle_lnHM.log, 
      lwd=2, col=col_vector[3], cex.axis=2.5)
...
plot(DD.results.GTEx.DEDD10$mean.discoveries$muscle_MD.zi, 
     DD.results.GTEx.DEDD10$mean.fdr$muscle_MD.zi, 
     type='l', ylim=c(0,0.9), xlim=c(0,2000), lwd=2, col=col_vector[1], 
     yaxt='n', xaxt='n', ylab=NA, xlab=NA)
axis(side=1, mgp=c(3,1.5,0), cex.axis=2.5)
axis(side=2, mgp=c(3,1,0), cex.axis=2.5)
mtext('GTEx muscle data', cex=1.5, side=3, line=-2.5)
lines(DD.results.GTEx.DEDD10$mean.discoveries$muscle_EVQ, 
      DD.results.GTEx.DEDD10$mean.fdr$muscle_EVQ, 
      lwd=2, col=col_vector[2], cex.axis=2.5)
lines(DD.results.GTEx.DEDD10$mean.discoveries$muscle_lnHM.log, 
      DD.results.GTEx.DEDD10$mean.fdr$muscle_lnHM.log, 
      lwd=2, col=col_vector[3], cex.axis=2.5)

plot(DD.results.GTEx.DEDD20$mean.discoveries$muscle_MD.zi, 
     DD.results.GTEx.DEDD20$mean.fdr$muscle_MD.zi, 
     type='l', ylim=c(0,0.9), xlim=c(0,2000), lwd=2, col=col_vector[1], 
     yaxt='n', xaxt='n', ylab=NA, xlab=NA)
axis(side=1, mgp=c(3,1.5,0), cex.axis=2.5)
axis(side=2, mgp=c(3,1,0), cex.axis=2.5)
lines(DD.results.GTEx.DEDD20$mean.discoveries$muscle_EVQ, 
      DD.results.GTEx.DEDD20$mean.fdr$muscle_EVQ, 
      lwd=2, col=col_vector[2], cex.axis=2.5)
lines(DD.results.GTEx.DEDD20$mean.discoveries$muscle_lnHM.log, 
      DD.results.GTEx.DEDD20$mean.fdr$muscle_lnHM.log, 
      lwd=2, col=col_vector[3], cex.axis=2.5)
