...
# inits$mean, disps, mean.prior.scale, disp.prior.scale; as well as initial 
# values for parameters estimated by GS for input to first iteration of MH 
# for other parameters: mean.prior.location, disp.prior.location
