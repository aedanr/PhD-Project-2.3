...
for (i in 44:50) {
  ...
  rm(dat.DESeq2.tmm, fit.DESeq2.tmm, 
     res.DESeq2.noif.tmm, res.lfc1.DESeq2.noif.tmm, res.lfc2.DESeq2.noif.tmm, 
  ...
  rm(dat.DESeq2.rle, fit.DESeq2.rle, 
     res.DESeq2.noif.rle, res.lfc1.DESeq2.noif.rle, res.lfc2.DESeq2.noif.rle, 
  ...
  rm(data, counts, DE, DEDD, lfcm1, lfcm2, libsizes, 
