...
for (samples_per_group in c(2,5,10,20,50)) {
  ...
  for (i in 1:10) {
    filename <- paste0("results.blood_", samples_per_group, "_set", i, "_DD.rds")
  ...
  saveRDS(results.DD, file=here(folder, paste0("DD.results.blood_", samples_per_group, "_DD.rds")))
  saveRDS(results.DD.lfc1, file=here(folder, paste0("DD.lfc1.results.blood_", samples_per_group, "_DD.rds")))
