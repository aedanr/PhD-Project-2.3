...
{
  DD.results.DEDD2$fdr <- DD.results.DEDD2$fdr[, c("disp.lfc1.MDSeq.zi.tmm", "disp.lfc1.lnHM.tmm")]
  DD.results.DEDD2$tpr <- DD.results.DEDD2$tpr[, c("disp.lfc1.MDSeq.zi.tmm", "disp.lfc1.lnHM.tmm")]
  DD.results.DEDD5$fdr <- DD.results.DEDD5$fdr[, c("disp.lfc1.MDSeq.zi.tmm", "disp.lfc1.lnHM.tmm")]
  DD.results.DEDD5$tpr <- DD.results.DEDD5$tpr[, c("disp.lfc1.MDSeq.zi.tmm", "disp.lfc1.lnHM.tmm")]
  DD.results.DEDD10$fdr <- DD.results.DEDD10$fdr[, c("disp.lfc1.MDSeq.zi.tmm", "disp.lfc1.lnHM.tmm")]
  DD.results.DEDD10$tpr <- DD.results.DEDD10$tpr[, c("disp.lfc1.MDSeq.zi.tmm", "disp.lfc1.lnHM.tmm")]
  DD.results.DEDD20$fdr <- DD.results.DEDD20$fdr[, c("disp.lfc1.MDSeq.zi.tmm", "disp.lfc1.lnHM.tmm")]
  DD.results.DEDD20$tpr <- DD.results.DEDD20$tpr[, c("disp.lfc1.MDSeq.zi.tmm", "disp.lfc1.lnHM.tmm")]
  DD.results.DEDD50$fdr <- DD.results.DEDD50$fdr[, c("disp.lfc1.MDSeq.zi.tmm", "disp.lfc1.lnHM.tmm")]
  DD.results.DEDD50$tpr <- DD.results.DEDD50$tpr[, c("disp.lfc1.MDSeq.zi.tmm", "disp.lfc1.lnHM.tmm")]
}
