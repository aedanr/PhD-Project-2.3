...
par(mfrow=c(3,5), mar=c(2.5,3.5,2.5,1), mgp=c(3,1.5,0))

# First row - compcodeR
plot(DEDD.results.compcodeR.DEDD2$mean.discoveries$dV.tmm, 
     DEDD.results.compcodeR.DEDD2$mean.fdr$dV.tmm, 
...
lines(DEDD.results.compcodeR.DEDD2$mean.discoveries$edgeR_HM.tmm, 
      DEDD.results.compcodeR.DEDD2$mean.fdr$edgeR_HM.tmm, 
      lwd=2, col=col_vector[2])
lines(DEDD.results.compcodeR.DEDD2$mean.discoveries$lnHMM.tmm, 
      DEDD.results.compcodeR.DEDD2$mean.fdr$lnHMM.tmm, 
...
plot(DEDD.results.compcodeR.DEDD10$mean.discoveries$dV.tmm, 
     DEDD.results.compcodeR.DEDD10$mean.fdr$dV.tmm, 
     type='l', ylim=c(0,1), xlim=c(0,2000), lwd=2, col=col_vector[1], 
     main=paste0("10 samples per group"), cex.main=2.5, yaxt='n', xaxt='n', ylab=NA, xlab=NA)
axis(side=1, mgp=c(3,1.5,0), cex.axis=2.5)
axis(side=2, mgp=c(3,1,0), cex.axis=2.5)
lines(DEDD.results.compcodeR.DEDD10$mean.discoveries$edgeR_HM.tmm, 
      DEDD.results.compcodeR.DEDD10$mean.fdr$edgeR_HM.tmm, 
      lwd=2, col=col_vector[2])
lines(DEDD.results.compcodeR.DEDD10$mean.discoveries$lnHMM.tmm, 
      DEDD.results.compcodeR.DEDD10$mean.fdr$lnHMM.tmm, 
      lwd=2, col=col_vector[3])

plot(DEDD.results.compcodeR.DEDD20$mean.discoveries$dV.tmm, 
     DEDD.results.compcodeR.DEDD20$mean.fdr$dV.tmm, 
     type='l', ylim=c(0,1), xlim=c(0,2000), lwd=2, col=col_vector[1], 
     main=paste0("20 samples per group"), cex.main=2.5, yaxt='n', xaxt='n', ylab=NA, xlab=NA)
axis(side=1, mgp=c(3,1.5,0), cex.axis=2.5)
axis(side=2, mgp=c(3,1,0), cex.axis=2.5)
lines(DEDD.results.compcodeR.DEDD20$mean.discoveries$edgeR_HM.tmm, 
      DEDD.results.compcodeR.DEDD20$mean.fdr$edgeR_HM.tmm, 
      lwd=2, col=col_vector[2])
lines(DEDD.results.compcodeR.DEDD20$mean.discoveries$lnHMM.tmm, 
      DEDD.results.compcodeR.DEDD20$mean.fdr$lnHMM.tmm, 
      lwd=2, col=col_vector[3])
...
lines(DEDD.results.compcodeR.DEDD50$mean.discoveries$lnHMM.tmm, 
      ...
      lwd=2, col=col_vector[3])
legend("topleft", col=col_vector[1:3], bty='n', cex=2, ncol=1, lty=1, lwd=2, 
       legend=c("diffVar", "Hybrid", "HMM"))

# Second row - blood
plot(DEDD.results.GTEx.DEDD2$mean.discoveries$blood_dV, 
     DEDD.results.GTEx.DEDD2$mean.fdr$blood_dV, 
     type='l', ylim=c(0,1), xlim=c(0,2000), lwd=2, col=col_vector[1], 
     yaxt='n', xaxt='n', ylab=NA, xlab=NA)
axis(side=1, mgp=c(3,1.5,0), cex.axis=2.5)
axis(side=2, mgp=c(3,1,0), cex.axis=2.5)
mtext('GTEx blood data', cex=1.5, side=3, line=-2.5)
lines(DEDD.results.GTEx.DEDD2$mean.discoveries$blood_voom_HM, 
      DEDD.results.GTEx.DEDD2$mean.fdr$blood_voom_HM, 
      lwd=2, col=col_vector[2], cex.axis=2.5)
lines(DEDD.results.GTEx.DEDD2$mean.discoveries$blood_lnHMM, 
      DEDD.results.GTEx.DEDD2$mean.fdr$blood_lnHMM, 
...
plot(DEDD.results.GTEx.DEDD10$mean.discoveries$blood_dV, 
     DEDD.results.GTEx.DEDD10$mean.fdr$blood_dV, 
     type='l', ylim=c(0,1), xlim=c(0,2000), lwd=2, col=col_vector[1], 
     yaxt='n', xaxt='n', ylab=NA, xlab=NA)
axis(side=1, mgp=c(3,1.5,0), cex.axis=2.5)
axis(side=2, mgp=c(3,1,0), cex.axis=2.5)
lines(DEDD.results.GTEx.DEDD10$mean.discoveries$blood_voom_HM, 
      DEDD.results.GTEx.DEDD10$mean.fdr$blood_voom_HM, 
      lwd=2, col=col_vector[2], cex.axis=2.5)
lines(DEDD.results.GTEx.DEDD10$mean.discoveries$blood_lnHMM, 
      DEDD.results.GTEx.DEDD10$mean.fdr$blood_lnHMM, 
      lwd=2, col=col_vector[3], cex.axis=2.5)

plot(DEDD.results.GTEx.DEDD20$mean.discoveries$blood_dV, 
     DEDD.results.GTEx.DEDD20$mean.fdr$blood_dV, 
     type='l', ylim=c(0,1), xlim=c(0,2000), lwd=2, col=col_vector[1], 
     yaxt='n', xaxt='n', ylab=NA, xlab=NA)
axis(side=1, mgp=c(3,1.5,0), cex.axis=2.5)
axis(side=2, mgp=c(3,1,0), cex.axis=2.5)
lines(DEDD.results.GTEx.DEDD20$mean.discoveries$blood_voom_HM, 
      DEDD.results.GTEx.DEDD20$mean.fdr$blood_voom_HM, 
      lwd=2, col=col_vector[2], cex.axis=2.5)
lines(DEDD.results.GTEx.DEDD20$mean.discoveries$blood_lnHMM, 
      DEDD.results.GTEx.DEDD20$mean.fdr$blood_lnHMM, 
      lwd=2, col=col_vector[3], cex.axis=2.5)
...
# Third row - muscle
plot(DEDD.results.GTEx.DEDD2$mean.discoveries$muscle_dV, 
     DEDD.results.GTEx.DEDD2$mean.fdr$muscle_dV, 
     type='l', ylim=c(0,1), xlim=c(0,2000), lwd=2, col=col_vector[1], 
     yaxt='n', xaxt='n', ylab=NA, xlab=NA)
axis(side=1, mgp=c(3,1.5,0), cex.axis=2.5)
axis(side=2, mgp=c(3,1,0), cex.axis=2.5)
mtext('GTEx muscle data', cex=1.5, side=3, line=-2.5)
lines(DEDD.results.GTEx.DEDD2$mean.discoveries$muscle_voom_HM, 
      DEDD.results.GTEx.DEDD2$mean.fdr$muscle_voom_HM, 
      lwd=2, col=col_vector[2], cex.axis=2.5)
lines(DEDD.results.GTEx.DEDD2$mean.discoveries$muscle_lnHMM, 
      DEDD.results.GTEx.DEDD2$mean.fdr$muscle_lnHMM, 
      lwd=2, col=col_vector[3], cex.axis=2.5)
...
plot(DEDD.results.GTEx.DEDD10$mean.discoveries$muscle_dV, 
     DEDD.results.GTEx.DEDD10$mean.fdr$muscle_dV, 
     type='l', ylim=c(0,1), xlim=c(0,2000), lwd=2, col=col_vector[1], 
     yaxt='n', xaxt='n', ylab=NA, xlab=NA)
axis(side=1, mgp=c(3,1.5,0), cex.axis=2.5)
axis(side=2, mgp=c(3,1,0), cex.axis=2.5)
lines(DEDD.results.GTEx.DEDD10$mean.discoveries$muscle_voom_HM, 
      DEDD.results.GTEx.DEDD10$mean.fdr$muscle_voom_HM, 
      lwd=2, col=col_vector[2], cex.axis=2.5)
lines(DEDD.results.GTEx.DEDD10$mean.discoveries$muscle_lnHMM, 
      DEDD.results.GTEx.DEDD10$mean.fdr$muscle_lnHMM, 
      lwd=2, col=col_vector[3], cex.axis=2.5)

plot(DEDD.results.GTEx.DEDD20$mean.discoveries$muscle_dV, 
     DEDD.results.GTEx.DEDD20$mean.fdr$muscle_dV, 
     type='l', ylim=c(0,1), xlim=c(0,2000), lwd=2, col=col_vector[1], 
     yaxt='n', xaxt='n', ylab=NA, xlab=NA)
axis(side=1, mgp=c(3,1.5,0), cex.axis=2.5)
axis(side=2, mgp=c(3,1,0), cex.axis=2.5)
lines(DEDD.results.GTEx.DEDD20$mean.discoveries$muscle_voom_HM, 
      DEDD.results.GTEx.DEDD20$mean.fdr$muscle_voom_HM, 
      lwd=2, col=col_vector[2], cex.axis=2.5)
lines(DEDD.results.GTEx.DEDD20$mean.discoveries$muscle_lnHMM, 
      DEDD.results.GTEx.DEDD20$mean.fdr$muscle_lnHMM, 
      lwd=2, col=col_vector[3], cex.axis=2.5)
