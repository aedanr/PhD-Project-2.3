...
results.list <- c(
  #names.edgeR, names.DESeq2, names.voom, names.DSS, names.baySeq, names.ShrinkBayes, 
...
for (i in 1:50) {
#  import <- paste0('results.DD10.',i,'.all.rds')
  import <- paste0('results.DD10.',i,'.rds')
...
saveRDS(results.DE, file=here('Results/DD compcodeR data results July-Aug 2019','DE.results.DD10.rds'))
saveRDS(results.DE.lfc1, file=here('Results/DD compcodeR data results July-Aug 2019','DE.lfc1.results.DD10.rds'))
saveRDS(results.DE.lfc2, file=here('Results/DD compcodeR data results July-Aug 2019','DE.lfc2.results.DD10.rds'))
saveRDS(results.DD, file=here('Results/DD compcodeR data results July-Aug 2019','DD.results.DD10.rds'))
saveRDS(results.DD.lfc1, file=here('Results/DD compcodeR data results July-Aug 2019','DD.lfc1.results.DD10.rds'))
saveRDS(results.DD.lfc2, file=here('Results/DD compcodeR data results July-Aug 2019','DD.lfc2.results.DD10.rds'))
saveRDS(results.DEDD, file=here('Results/DD compcodeR data results July-Aug 2019','DEDD.results.DD10.rds'))
...
# match in the loop.
results.DE <- readRDS(here('Results/DD compcodeR data results July-Aug 2019','DE.results.DD10.rds'))
results.DE.lfc1 <- readRDS(here('Results/DD compcodeR data results July-Aug 2019','DE.lfc1.results.DD10.rds'))
results.DE.lfc2 <- readRDS(here('Results/DD compcodeR data results July-Aug 2019','DE.lfc2.results.DD10.rds'))
results.DD <- readRDS(here('Results/DD compcodeR data results July-Aug 2019','DD.results.DD10.rds'))
results.DD.lfc1 <- readRDS(here('Results/DD compcodeR data results July-Aug 2019','DD.lfc1.results.DD10.rds'))
results.DD.lfc2 <- readRDS(here('Results/DD compcodeR data results July-Aug 2019','DD.lfc2.results.DD10.rds'))
results.DEDD <- readRDS(here('Results/DD compcodeR data results July-Aug 2019','DEDD.results.DD10.rds'))
