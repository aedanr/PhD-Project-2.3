...
# Merge and save results files ####
# ShrinkBayes only for DEDD2
# lfc1.lnHM_lfc2.lnHM for DE
...
#  res.ShrinkBayes <- res.ShrinkBayes[-(1:7)]
  res.edgeR_baySeq_MDSeq <- readRDS(here('Results/DE compcodeR data results July-Aug 2019', 
                                  paste0('results.DE10.',i,'.edgeR_baySeq_MDSeq.rds')))
  res.lfc1.lnHM_lfc2.lnHM <- readRDS(here('Results/DE compcodeR data results July-Aug 2019', 
                                          paste0('results.DE10.',i,'.lfc1.lnHM_lfc2.lnHM.rds')))
  res.lfc1.lnHM_lfc2.lnHM <- res.lfc1.lnHM_lfc2.lnHM[-(1:4)]
  res.rest <- readRDS(here('Results/DE compcodeR data results July-Aug 2019', 
                                  paste0('results.DE10.',i,'.rds')))
...
# MDSeq uses p.adjust() with method ='BY' by default.
...
for (i in 1:50) {
  # import <- paste0('results.DEDD20.',i,'.all.rds')
  import <- paste0('results.DEDD20.',i,'.rds')
...
saveRDS(results.DE, file=here('Results/DEDD compcodeR data results July-Aug 2019','DE.results.DEDD20.rds'))
saveRDS(results.DE.lfc1, file=here('Results/DEDD compcodeR data results July-Aug 2019','DE.lfc1.results.DEDD20.rds'))
saveRDS(results.DE.lfc2, file=here('Results/DEDD compcodeR data results July-Aug 2019','DE.lfc2.results.DEDD20.rds'))
saveRDS(results.DD, file=here('Results/DEDD compcodeR data results July-Aug 2019','DD.results.DEDD20.rds'))
saveRDS(results.DD.lfc1, file=here('Results/DEDD compcodeR data results July-Aug 2019','DD.lfc1.results.DEDD20.rds'))
saveRDS(results.DD.lfc2, file=here('Results/DEDD compcodeR data results July-Aug 2019','DD.lfc2.results.DEDD20.rds'))
saveRDS(results.DEDD, file=here('Results/DEDD compcodeR data results July-Aug 2019','DEDD.results.DEDD20.rds'))
...
# match in the loop.
results.DE <- readRDS(here('Results/DD compcodeR data results July-Aug 2019','DE.results.DD20.rds'))
results.DE.lfc1 <- readRDS(here('Results/DD compcodeR data results July-Aug 2019','DE.lfc1.results.DD20.rds'))
results.DE.lfc2 <- readRDS(here('Results/DD compcodeR data results July-Aug 2019','DE.lfc2.results.DD20.rds'))
results.DD <- readRDS(here('Results/DD compcodeR data results July-Aug 2019','DD.results.DD20.rds'))
results.DD.lfc1 <- readRDS(here('Results/DD compcodeR data results July-Aug 2019','DD.lfc1.results.DD20.rds'))
results.DD.lfc2 <- readRDS(here('Results/DD compcodeR data results July-Aug 2019','DD.lfc2.results.DD20.rds'))
results.DEDD <- readRDS(here('Results/DD compcodeR data results July-Aug 2019','DEDD.results.DD20.rds'))
...
saveRDS(results.DE, file=here('Results/DD compcodeR data results July-Aug 2019','DE.results.DD20.rds'))
saveRDS(results.DE.lfc1, file=here('Results/DD compcodeR data results July-Aug 2019','DE.lfc1.results.DD20.rds'))
saveRDS(results.DE.lfc2, file=here('Results/DD compcodeR data results July-Aug 2019','DE.lfc2.results.DD20.rds'))
saveRDS(results.DD, file=here('Results/DD compcodeR data results July-Aug 2019','DD.results.DD20.rds'))
saveRDS(results.DD.lfc1, file=here('Results/DD compcodeR data results July-Aug 2019','DD.lfc1.results.DD20.rds'))
saveRDS(results.DD.lfc2, file=here('Results/DD compcodeR data results July-Aug 2019','DD.lfc2.results.DD20.rds'))
saveRDS(results.DEDD, file=here('Results/DD compcodeR data results July-Aug 2019','DEDD.results.DD20.rds'))
