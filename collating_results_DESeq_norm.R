...
for (i in 1:50) {
  ...
  res <- readRDS(here('Results/DE compcodeR data results DESeq2 norm Aug 2019', import))
...
for (i in c(
  names.edgeR, names.DESeq2, names.voom, names.DSS, names.MDSeq)) {
  for (j in c('raw.','fdr.')) {
...
saveRDS(results.DE, file=here('Results/DE compcodeR data results DESeq2 norm Aug 2019','DE.results.DE5.DESeqnorm.rds'))
saveRDS(results.DE.lfc1, file=here('Results/DE compcodeR data results DESeq2 norm Aug 2019','DE.lfc1.results.DE5.DESeqnorm.rds'))
saveRDS(results.DE.lfc2, file=here('Results/DE compcodeR data results DESeq2 norm Aug 2019','DE.lfc2.results.DE5.DESeqnorm.rds'))
# saveRDS(results.DD, file=here('Results/DE compcodeR data results DESeq2 norm Aug 2019','DD.results.DE5.DESeqnorm.rds'))
# saveRDS(results.DD.lfc1, file=here('Results/DE compcodeR data results DESeq2 norm Aug 2019','DD.lfc1.results.DE5.DESeqnorm.rds'))
# saveRDS(results.DD.lfc2, file=here('Results/DE compcodeR data results DESeq2 norm Aug 2019','DD.lfc2.results.DE5.DESeqnorm.rds'))
saveRDS(results.DEDD, file=here('Results/DE compcodeR data results DESeq2 norm Aug 2019','DEDD.results.DE5.DESeqnorm.rds'))
